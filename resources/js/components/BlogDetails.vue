      ...
      <div class="container flexjustify-center">
        <div class="w-full sm:w-9/12  ml-auto mr-auto">
          <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-9/12 h-64 sm:h-auto bg-indigo-900 bg-cover relative flex items-center justify-center" style="background-image: url('https://m.media-amazon.com/images/M/MV5BOTE3NzIyZTktMWQwNy00MDUwLTk0ZDgtMTU3M2M3MTQ0MTg1XkEyXkFqcGdeQXVyMjgzMTEzNDU@._V1_.jpg')">
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="text-white z-10 relative cursor-pointer transition duration-500 transform hover:scale-110"><circle cx="12" cy="12" r="10"></circle><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>
              <div class="opacity-75 bg-black w-full h-full left-0 top-0 absolute"></div>
            </div>
          </div>
          <div class="flex flex-wrap">
            <div class="w-full sm:w-3/12 bg-white flex">
              <figure class="mt-5 mb-4 ml-auto mr-auto sm:-mt-16 sm:mr-0 sm:ml-8 sm:mb-0 w-full relative">
                <div
                  class="absolute w-10 h-12 -mt-3 -ml-3 bg-gray-200 z-0 hidden sm:block"
                ></div>
                <img
            ...
            <div class="w-full sm:w-9/12 bg-gray-100 flex">
              <div
                class="bg-white sm:-mt-16 sm:mr-8 w-full h-64 relative rounded-tr-lg"
              >
